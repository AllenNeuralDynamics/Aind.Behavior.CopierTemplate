...
TModel = TypeVar("TModel", bound=Union[{{ _python_class_prefix }}Rig, {{ _python_class_prefix }}TaskLogic, AindBehaviorSessionModel])
...
class BonsaiTests(unittest.TestCase):
    def test_deserialization(self):
        ...
        models_to_test = [
            ...
            TestModel(bonsai_property="RigPath", json_root=JSON_ROOT, model={{ _python_class_prefix }}Rig),
            TestModel(bonsai_property="TaskLogicPath", json_root=JSON_ROOT, model={{ _python_class_prefix }}TaskLogic),
        ]
