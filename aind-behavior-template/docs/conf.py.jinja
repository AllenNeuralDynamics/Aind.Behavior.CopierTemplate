...
import {{ _python_package_name }}
import {{ _python_package_name }}.data_contract as contract
import {{ _python_package_name }}.rig
import {{ _python_package_name }}.task_logic

SOURCE_ROOT = "https://github.com/AllenNeuralDynamics/{{ _dotnet_full_name }}/tree/main/src/"
...
author = " {{ author_name }} "
release = {{ _python_package_name }}.__semver__
...
export_model_diagram({{ _python_package_name }}.task_logic.{{ _python_class_prefix }}TaskLogic, _static_path)
